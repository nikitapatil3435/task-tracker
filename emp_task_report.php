...
require_once('tcpdf/tcpdf.php');
	...
	$obj_pdf = new TCPDF('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);  
      ...
      $content = '';	 
	$today=date("Y-m-d");
	$wrkid="Employee-Task-Report";

	
	//echo "*","vw_task where assign_to='".$_session['user_id']."' order by due_date DESC";
	$today_task=get_data("*","vw_task where assign_to='".$_SESSION['user_id']."'order by due_date DESC");
    
	if(isset($today_task)){
      $content .= '<h3 align="center">Employee-Task-Report</h3><br><br/>  
