	...
	DateTimePicker.prototype = {
		...
		_addEventHandlersForInput: function()
		{
			...
			if(!oDTP.settings.isInline)
			{
				...
				$(oDTP.settings.parentElement).find(".apply_plugin").each(function()
				{
					$(this).attr("data-field", $(this).attr("type"));
					$(this).attr("type", "text");
				});	
		...
		setDateTimeStringInInputField: function(oInputField, dInput)
		{
			...
			else
			{
				...
				{
					oArrElements = $(oDTP.settings.parentElement).find(".set_default_value");
				}
				else
				{
					oArrElements = $(".set_default_value");
				}
			}
