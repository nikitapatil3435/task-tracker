...
if (isset($_POST['login'])) {
 //echo 
 //get_data("emp_id,role,emp_name", "tbl_employee_detail where emp_name='" . $_POST['emp_name'] . "' and password='" . $_POST['password'] . "'");
 $login = get_data("empid,role,emp_name", "tbl_employee_detail where emp_name='" . $_POST['emp_name'] . "' and password='" . $_POST['password'] . "'");
  if (isset($login)) {
...
if (isset($_POST['save_details'])) {
  ...
  echo "call rolewiserights('$_POST[user_id]','$_POST[menu]','$_POST[menu_link]','$_POST[menu_ref]','$_POST[menu_text]','$_POST[is_allowed]','$_POST[isinsert]','$_POST[isedit]','$_POST[isdelete]','$_POST[issearch]','$_POST[isprint]','$_POST[isapprove]','$_POST[is_default]',0,'$adduserdate',1)";
